...
class PlotsController extends Controller
{
    ...
    public function addPlot(Request $request){
        $validatedPlotData=$request->validate([
            ...
            $installment_total=$validatedPlotData['plot_size'] *  $validatedPlotData['installment_price_per_sqm'];
            $addPlot->installment_total_value=$installment_total;
            $addPlot->monthly_installment_price =$installment_total/$project->installment_period;
