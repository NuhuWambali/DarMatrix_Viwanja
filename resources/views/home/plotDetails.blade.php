...
<table class="table table-bordered  table-responsive roundedCorners"  >
    <tbody>
        ...
        <tr>
            <th>Land Use</th>
            <td>{{$plot->land_use}}</td>
            <th>Installment Price Per SQM</th>
            <td>Tsh {{number_format($plot->installment_price_per_sqm)}}</td>
        </tr>
        <tr>
            <th>Installment Period</th>
            <td>{{$plot->installment_period}} Months</td>
            <th>Monthly Installment Price</th>
            <td>Tsh {{number_format($plot->monthly_installment_price)}}</td>
        </tr>
        <tr>
            <th>Total Cash </th>
            <td>Tsh {{number_format($plot->cash_total_value)}}</td>
            <th>Installment Total Price</th>
            <td>Tsh {{number_format($plot->installment_total_value)}}</td>
        </tr>
        <tr>
            <th>Desription 1</th>
