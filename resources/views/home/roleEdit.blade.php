        ...
        <div class="card-body">
          <div class="example">
            <div class="tab-content rounded-bottom">
                <form action="{{route('createEditRole',$role->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                        <div class="mb-3 row">
                            <label class="col-sm-1 col-form-label" for="inputPassword">Name</label>
                            <div class="col-sm-7">
                            <input class="form-control @error('role_name') is-invalid @enderror" type="text" id="role_name" name="role_name" value="{{$role->role_name}}" required>
                            @error('role_name')
